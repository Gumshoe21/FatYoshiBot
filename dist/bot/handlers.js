...
exports.commandHandler = (channel, context, message, self) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!cooldownIsActive) tmiClient_1.default.say(channel, response);
  });
exports.redemptionHandler = (channel, username, type, tags, message) =>
  __awaiter(void 0, void 0, void 0, function* () {
    console.log(type);
