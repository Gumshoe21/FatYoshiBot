...
exports.updateMe = catchAsync(
  async (
    req: { body: { password: any; passwordConfirm: any }; user: { id: any } },
    res: {
      status: (arg0: number) => {
        (): any;
        new (): any;
        json: {
          (arg0: { status: string; data: { user: any } }): void;
          new (): any;
        };
      };
    },
  ...
  async (
    ...
    res: {
      status: (arg0: number) => {
        (): any;
        new (): any;
        json: { (arg0: { status: string; data: null }): void; new (): any };
      };
    },
    _next: any
  ) => {
  ...
  async (
    ...
    res: {
      status: (arg0: number) => {
        ...
        new (): any;
        json: {
          (arg0: { status: string; data: { data: number } }): void;
          new (): any;
        };
      };
    },
